# Huion H420 Linux Configuration Tool for OSU!
...
- Linux с поддержкой xinput (для Linux Mint рекомендуется X11-сессия для максимальной стабильности)
- Планшет Huion H420
...
- Профиль для osu! с фиксированной областью и параметрами кнопок
- Сохранение текущих параметров как заранее заданный профиль osu!
...
- Повторные попытки, сигнатуры устройства и fallback-поиск для более стабильного обнаружения планшета
